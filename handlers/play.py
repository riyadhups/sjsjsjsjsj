            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "**Assistant Account [Kafkaz ᵃˢⁱˢᵗᵃⁿᵗ](https://t.me/KafkazAsistan) Uğurla Qoşuldu.\n\nİndi Musiqi Başlayır**")

                except UserAlreadyParticipant:
                    pass
                except Exception:
                    await lel.edit(
                        f"Assistant ın banını açın\nİstifadəçi adı: @KafkazAsistan\nKöməkçi ID: `5512476886`")
    try:
    ...
    if audio:
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                      [
            [
                InlineKeyboardButton("🥂 Blog Kanalı", url=f"https://t.me/Riyadd"),
                InlineKeyboardButton("📣 Rəsmi Kanal", url=f"https://t.me/RiyaddBlog"),
            ],[
